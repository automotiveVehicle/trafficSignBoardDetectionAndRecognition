...
3.Choosing default boundary boxes:- Each feature map layer in SSD has a scale value specified. Conv4 3 identifies things at the smallest size of 0.2 starting from the left.
